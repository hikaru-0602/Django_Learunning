...
SECRET_KEY = 'django-insecure-s^6prl5n8ch)gv-y63-q_h3!r6bclu=c!gspbry(%=51hukyy_'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  #認証システムを提供するアプリケーション
    'django.contrib.contenttypes',  #コンテンツタイプフレームワークを提供するアプリケーション
...
LOGIN_REDIRECT_URL = '/'  #ログイン後のリダイレクト先のURL
LOGOUT_REDIRECT_URL = '/'  #ログアウト後のリダイレクト先のURL
